...
* I was able to use this vulnerability to gain RCE on SaaS code scanning product. This CVE serves as a reminder that third-party linting tools should be used with caution, and idealy executed inside a sandbox. 
